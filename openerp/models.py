...
class BaseModel(object):
    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    def create_workflow(self, cr, uid, ids, context=None):
        ...
        for res_id in ids:
            workflow.trg_create(uid, self._name, res_id, cr,context)
    ...
    def delete_workflow(self, cr, uid, ids, context=None):
        ...
        from openerp import workflow
        for res_id in ids:
            workflow.trg_delete(uid, self._name, res_id, cr, context)
        self.invalidate_cache(cr, uid, context=context)
        return True
    ...
    def step_workflow(self, cr, uid, ids, context=None):
        ...
        from openerp import workflow
        for res_id in ids:
            workflow.trg_write(uid, self._name, res_id, cr, context)
        # self.invalidate_cache(cr, uid, context=context) ?
        return True
    ...
    def signal_workflow(self, cr, uid, ids, signal, context=None):
        ...
        result = {}
        for res_id in ids:
            result[res_id] = workflow.trg_validate(uid, self._name, res_id, signal, cr, context)
        # self.invalidate_cache(cr, uid, context=context) ?
        return result
    ...
    def redirect_workflow(self, cr, uid, old_new_ids, context=None):
        ...
        for old_id, new_id in old_new_ids:
            workflow.trg_redirect(uid, self._name, old_id, new_id, cr, context)
        self.invalidate_cache(cr, uid, context=context)
        return True
    ...
    def _write(self, cr, user, ids, vals, context=None):
        ...
        self.step_workflow(cr, user, ids, context)
        return True
    ...
    def _create(self, cr, user, vals, context=None):
        ...
        self.create_workflow(cr, user, [id_new], context)
        return id_new
