...
def trg_write(uid, res_type, res_id, cr,context):
    """
    ...
    """
    return WorkflowService.new(cr, uid, res_type, res_id, context).write()
...
def trg_delete(uid, res_type, res_id, cr, context):
    """
    ...
    :param cr: a database cursor
    """
    return WorkflowService.new(cr, uid, res_type, res_id, context).delete()

def trg_create(uid, res_type, res_id, cr, context):
    """
    ...
    :param cr: a database cursor
    """
    return WorkflowService.new(cr, uid, res_type, res_id,context ).create()

def trg_validate(uid, res_type, res_id, signal, cr, context ):
    """
    ...
    return WorkflowService.new(cr, uid, res_type, res_id, context).validate(signal)

def trg_redirect(uid, res_type, res_id, new_rid, cr, context):
    """
    ...
    return WorkflowService.new(cr, uid, res_type, res_id, context).redirect(new_rid)
